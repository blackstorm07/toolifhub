...
export default function ToolError({ error, reset }) {
  return (
    <div className="page min-h-[50vh] flex flex-col items-center justify-center text-center">
      ...
      <h1 className="text-2xl font-bold mb-2">Something went wrong loading this tool</h1>
      <p className="text-muted-foreground mb-8 max-w-md">
        Please try again, or head back to browse other tools.
      </p>
      <div className="flex flex-col sm:flex-row gap-4">
        ...
        >
          <Home className="w-4 h-4" /> Browse Tools
        </Link>
      </div>
    </div>
  );
